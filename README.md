...
Cybersecurity Analyst and AI Engineer building autonomous systems that trade, learn, and improve themselves.

SOC Analyst by day -- I monitor, detect, and respond to threats across enterprise environments. After hours, I build AI-powered infrastructure on self-hosted hardware: trading bots, multi-agent orchestration platforms, and GPU-accelerated LLM pipelines.
...
**AI/ML:** Grok/xAI Responses API, Ollama (qwen3, nomic-embed-text), OpenAI, Anthropic Claude
